...
function mat3:det()
	return
		self.zx*(self.xy*self.yz - self.xz*self.yy) +
		self.zy*(self.xz*self.yx - self.xx*self.yz) +
		self.zz*(self.xx*self.yy - self.xy*self.yx)
end
...
function mat3.__div(a, b) return new(a.xx/b, a.yx/b, a.zx/b, a.xy/b, a.yy/b, a.zy/b, a.xz/b, a.yz/b, a.zz/b) end
